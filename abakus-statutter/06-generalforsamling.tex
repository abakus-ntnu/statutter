...
\begin{enumerate}[label=\alph*)]
    ...
    \item Hovedstyret skal i forkant av ordinær generalforsamling lyse ut alle stillinger i Hovedstyret innad i Abakus minst
    \textbf{én måned} før generalforsamlingen.
    \item Hovedstyret skal i forkant av sekundær generalforsamling lyse ut halvparten av stillingene i Fondsstyret innad i Abakus
    minst \textbf{én måned} før generalforsamlingen.
